...
- To check the history of the image run the command `docker history name_of_image`
...
- `docker volumes ls` - lists volumes available
- `docker volume create sre_zeeshan_volume` - creates a volume 
- `docker inspect sre_zeeshan_volume` - inspects the volume
- `docker volume rm sre_zeeshan_volume` - deletes the volume

![image](https://user-images.githubusercontent.com/88186084/135251222-12275625-a700-4a8d-ae25-0a77f4014592.png)
